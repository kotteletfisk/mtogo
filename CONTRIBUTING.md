...
5. Merge changes from main into your working branch.
4. Run tests locally using the dev container config in the repo. Make sure they pass.
5. Push the branch to the remote repository.
6. Open a pull request on main, if any changes are found on services, relevant tests will run. If they pass, merge the changes. Else it's back to the drawing board!
5. Once the issue is resolved, delete working branch.