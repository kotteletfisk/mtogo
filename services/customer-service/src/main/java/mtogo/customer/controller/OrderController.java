...
public class OrderController {
    ...
    public void createOrder(Context ctx){
        ...
        try {
            orderDetailsDTO = validateOrderDTO(ctx);
        } catch (Exception e) {
            ctx.status(400).result("Invalid order data: " + e.getMessage());
            return;
        }
        ...
        try {
            ...
            boolean published = Producer.publishMessage("customer:order_creation", payload);
